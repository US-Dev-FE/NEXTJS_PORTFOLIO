...
export const serviceData = [
    ...
    { icon: assets.graphics_icon, title: 'Consultant', description: 'Providing expert frontend consulting to build fast, scalable, and user-first solutions...', link: '' },
]

export const infoList = [
    { icon: assets.code_icon, iconDark: assets.code_icon_dark, title: 'Languages', description: 'HTML, CSS, JavaScript, Angular,  React Js, Next Js' },
