    ...
    return (
        <motion.div initial={{ opacity: 0 }}
            ...
            <motion.a initial={{ opacity: 0 }}
                whileInView={{ opacity: 1 }}
                transition={{ duration: 0.5, delay: 1.1 }} target='_blank' className={`w-max flex items-center justify-center gap-2 text-gray-700
            border-[0.5px] border-gray-700 rounded-full py-3 px-10 mx-auto
            my-20 bg-lightHover duration-500 ${isDarkMode ? 'text-white border-white bg-darkHover' : ''}`} href='https://github.com/US-Dev-FE'>Show more
